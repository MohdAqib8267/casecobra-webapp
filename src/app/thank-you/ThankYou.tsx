...
const ThankYou = () => {
    ...
    return (
      ...
      <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
        ...
        <div className='flex space-x-6 md:w-[12rem] overflow-hidden mt-4 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:rounded-5xl'>
          {/* <PhonePreview
